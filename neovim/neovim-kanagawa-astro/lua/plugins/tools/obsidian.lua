return {
  ...
  opts = {
    workspaces = {
      ...
      {
        name = "research-gayb-dosyasi",
        path = "~/Documents/vaults/research-gayb-dosyasi/",
      },
      -- FIX: obsidian => rearrange paths and names
    },

    log_level = vim.log.levels.INFO,

    -- FIX: obsidian => new note place
    ...
    daily_notes = {
      ...
      date_format = "%Y-%m-%d",
      alias_format = "%B %-d, %Y",
      -- FIX: obsidian => default tags
      default_tags = { "journal", "daily", "daily-notes" },
      -- FIX: obsidian => new note template
      template = nil,
    },
    completion = {
      nvim_cmp = true,
    ...
    templates = {
      ...
      date_format = "%Y-%m-%d-%a",
      time_format = "%H:%M",
      -- TODO: obsidian =>learn to create new note from template
    },
