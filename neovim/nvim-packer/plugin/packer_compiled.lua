...
_G.packer_plugins = {
  ...
  ["cyberdream.nvim"] = {
    loaded = true,
    path = "/home/gokayburuc/.local/share/nvim/site/pack/packer/start/cyberdream.nvim",
  ...
  ["fruitypebbles.nvim"] = {
    loaded = true,
    path = "/home/gokayburuc/.local/share/nvim/site/pack/packer/start/fruitypebbles.nvim",
    url = "https://github.com/BoilingSoup/fruitypebbles.nvim"
  },
  ["gitsigns.nvim"] = {
    loaded = true,
  ...
  ["icon-picker.nvim"] = {
    ...
    loaded = true,
    path = "/home/gokayburuc/.local/share/nvim/site/pack/packer/start/icon-picker.nvim",
  ...
  ["noctis.nvim"] = {
    loaded = true,
    path = "/home/gokayburuc/.local/share/nvim/site/pack/packer/start/noctis.nvim",
  ...
  ["onedarkhc.vim"] = {
    loaded = true,
    path = "/home/gokayburuc/.local/share/nvim/site/pack/packer/start/onedarkhc.vim",
  ...
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/home/gokayburuc/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
  ...
  ["toggleterm.nvim"] = {
    ...
    loaded = true,
    path = "/home/gokayburuc/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
